...
<div class="${"relative top-12 mx-2 mb-20"}"><div class="${"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 ml-4 mr-4"}">${each(data.bestuur.items, (lid) => {
    return `<div class="${"relative z-10 bg-black rounded-lg right-0.5 praesidiumkaart svelte-1ukk3fk"}"><div class="${"grid grid-cols-2 gap-1 h-96"}"><img${add_attribute("src", lid.fotoUrl, 0)}${add_attribute("alt", lid.naam, 0)} draggable="${"false"}" class="${"absolute -z-10 border-none w-full h-96 rounded-lg object-cover"}">
...
//# sourceMappingURL=_page.svelte-7a218374.js.map
